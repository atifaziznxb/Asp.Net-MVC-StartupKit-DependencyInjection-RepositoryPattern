...
namespace Sample_Architecutre
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<Sample_Architecture_Context>()));
    ...
    public class ApplicationRoleManager : RoleManager<ApplicationRole>
    {
            ...
            IdentityFactoryOptions<ApplicationRoleManager> options, IOwinContext context)
        {
            return new ApplicationRoleManager(
                new RoleStore<ApplicationRole>(context.Get<Sample_Architecture_Context>()));
        }
    }
}
